...
public class RasgoClase {
	...
	/**
	 * Desv�o est�ndar del rasgo para los objetos de la clase.
	 */
	...
	/**
	 * Valor m�ximo del rasgo para los objetos de la clase.
	 */
	private Double maximo;

	/**
	 * Valor m�ximo real del rasgo para los objetos de la clase.
	 * El atributo m�ximo puede no ser el m�ximo real de los objetos clasificados, esto depende de si
	 * el rango es variable o no y del valor por defecto inicial para el valor minimo. 
	 */
	private Double maximoReal;

	/**
	 * Valor m�nimo del rasgo para los objetos de la clase.
	 */
	private Double minimo;
	
	/**
	 * Valor m�nimo real del rasgo para los objetos de la clase.
