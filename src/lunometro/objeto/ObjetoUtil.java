...
public class ObjetoUtil {
	...
	public static void pintarPunto(Pixel p, Objeto o, TiledImage ti, Pixel medio, int width, int height){
	...
	/**
	 * Calcula el punto de intersecci�n de dos rectas: <a * x + b * y + c = 0> y <d * x + e * y + f = 0> 
	 * @param a
	 * @param b
	 * @param c
	 * @param d
	...
	/**
	 * Calcula la media del vector de valores pasado como par�metro
	 * @param vector
	 * @return Valor medio
	 */
