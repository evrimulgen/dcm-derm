...
public class RasgoObjetoHistograma extends RasgoObjeto {
	...
	/**
	 * Retorna el valor 1 para todos los histogramas ya que valor ideal de comparaci�n de dos histogramas es 1.
	 * Esto asegura que al decidir si un objeto pertece a una de dos clases, se seleccione aquella clase para la cual
	 * el valor de comparaci�n del histograma en la clase se mas cercano a 1 (@see objeto.clase#distanciaPromedio(Objeto)). 
