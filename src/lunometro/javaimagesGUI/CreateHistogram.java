...
public class CreateHistogram {
     ...
     */
    public enum availableChannel{red,green,blue,alpha,grayscale}
    ...
    /**
     * Create a bar graph with the histogram and draws on the Jpanel (jPanelHistogram)
     * @param histogram frequency histogram of an image (int[256])
     * @param jPanelHistogram JPanel where the histogram will be drawn
     * @param chanel Histogram Channel (depending on the selected channel, the bar graph will be drawn to that color)
