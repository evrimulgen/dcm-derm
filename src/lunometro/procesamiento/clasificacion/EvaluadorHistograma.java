...
public abstract class EvaluadorHistograma extends EvaluadorRasgo {
	...
	public RasgoObjeto calcularValor(Objeto objeto) {
		...
		if (countHistogramas > 0){
			double distanciaProm = distanciaSum / countHistogramas;
			rasgoObjeto.setValor(distanciaProm);
		}else{
			rasgoObjeto.setValor(null);
		}
		return rasgoObjeto;
	}
	...
	/**
	 * Busca el histograma con del tipo pasado como par�netro
	 * @param tipo
	 * @param histogramas
	 * @return
	 */
