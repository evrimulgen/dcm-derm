...
public class SumaAngulos extends EvaluadorRasgo {
	/**
	 * Cantidad de pixeles del contorno a utilizar para ver si un pixel se desv�a 
	 * demasiado del contorno. Lo que indicar�a que pertenece a otro objeto
	 */
	...
	/**
	 * Retorna 1 si el Maiz esta quebrado, 0 si no lo est�.
	 */
