...
/*****************************
 * CLASE PROVISORIA - MOVER A LIB PIXELMED 
 *****************************
 */
package in.raster.mayam;
...
//System.err.println("ImageToDicom.main(): SOP Class = "+sopClass);
	...
	public static void main(String arg[]) {
		...
		try {
			...
			new com.pixelmed.dicom.ImageToDicom(arg[0],arg[1],arg[2],arg[3],arg[4],arg[5],arg[6],modality,sopClass);
		}
		catch (Exception e) {
			e.printStackTrace();
		}
