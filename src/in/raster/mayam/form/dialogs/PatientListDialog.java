...
import in.raster.mayam.models.PatientModel;
...
public class PatientListDialog extends javax.swing.JDialog {
    ...
    public PatientListDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        PatientDetailTableModel model = new PatientDetailTableModel();
        model.setData(ApplicationContext.databaseRef.listAllLocalPatients());
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (selection != -1) {
           patient = (PatientModel) jTable1.getModel().getValueAt(selection, 3);
           setVisible(false);
        } else {
            JOptionPane.showMessageDialog(this,ApplicationContext.currentBundle.getString("Alert.patientNotSelected"),
    ...
    private class PatientDetailTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            PatientModel patient = (PatientModel) patients.get(rowIndex);
            switch (columnIndex) {
                case 0:
