...
public final class MultiRegionManagerModel extends AbstractModel {
    ...
    public MultiRegionManagerModel() {
        ...
        addRegion(new Region("Piel Sana", Color.WHITE/*nextColor()*/));
        addRegion(new Region("Lesion", Color.BLACK/*nextColor()*/));
...
//        });
    ...
    public void setImageSource(ImagePlus srcImage) {
        lastSourceImage = srcImage;
    }
    ...
    void actionAddSubRegion() {
        ...
        final ImagePlus imp = this.lastSourceImage;//UIUtils.getImage();
        if (imp == null) {
            return;
        }
