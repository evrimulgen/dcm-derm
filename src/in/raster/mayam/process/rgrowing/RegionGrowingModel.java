 ...
 * @since Feb 18, 2008
 */
public class RegionGrowingModel extends AbstractModel {
    ...
    public void actionRun() {
        ...
        final ImagePlus imp = multiRegionManagerModel.getSourceImage(); //UIUtils.getImage();
        if (imp == null) {
            return;
        }
        ...
        impResult = new ImagePlus("ROIs", result.segments);
        ...
        impResult.updateAndRepaintWindow();
        // Display results
